      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center h-16">
          ...
          <div className="flex items-center space-x-0.5 shrink-0 pr-2">
            ...
            {/* Mobile links */}
            <Link href="/wishlist" data-fly-target="wishlist-icon" className="relative p-2.5 text-gray-900 sm:hidden rounded-xl hover:bg-lime-50">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
            ...
            <Link href="/cart" data-fly-target="cart-icon" className="relative p-2.5 text-gray-900 sm:hidden rounded-xl hover:bg-gray-50">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z" /></svg>
